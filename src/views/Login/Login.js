      ...
      <div>
        <header>
          <div className="container">
            <div className="leftlogo"><Link to="/dashboard"><img src="images/usbank_logo.png" alt="logo" className="img-responsive"/></Link></div>
              ...
              <div className="bannerformright">
                <form action="#" method="post">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-12">
                      <button className="lgbtnhome" type="submit">Log In</button>
                    </div>
                    <div className="col-md-12">
